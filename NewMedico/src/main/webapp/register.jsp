					...
					<form action="User" class="form" method="post">
						<div class="row">
							<div class="label">
								...
								<label for="Phone">Phone:</label> <label for="profile">Profile:</label>
								<label for="password">Password:</label>

							</div>
							<div class="input-container">
								<input type="text" name="name" required="required"> <input
									type="email" name="email" required="required"> <input
									type="text" name="phone" required="required"> <select
									name="type" id="cars">
						...
						<input type="submit" value="register" name="typeofuseraction"
							required="required">
					</form>
