...
.col-4, .col-8, .col, .col-md-10, .col-md-12, .col-lg-3, .col-lg-4,
	.col-lg-6, .col-lg-7, .col-xl-4, .col-xl-6, .col-xl-8 {
	position: relative;
	width: 100%;
	min-height: 1px;
	padding-right: 15px;
...
.btn-primary:focus {
	box-shadow: 0 4px 6px rgba(50, 50, 93, .11), 0 1px 3px
		rgba(0, 0, 0, .08), 0 0 0 0 rgba(94, 114, 228, .5);
}
...
.btn-info:focus {
	box-shadow: 0 4px 6px rgba(50, 50, 93, .11), 0 1px 3px
		rgba(0, 0, 0, .08), 0 0 0 0 rgba(17, 205, 239, .5);
}
...
.btn-default:focus {
	box-shadow: 0 4px 6px rgba(50, 50, 93, .11), 0 1px 3px
		rgba(0, 0, 0, .08), 0 0 0 0 rgba(23, 43, 77, .5);
}
...
<body>
	<%
	UserEntity u = (UserEntity) request.getAttribute("userdetails");
	%>
	<div class="main-content">
						...
						aria-expanded="false">
							<div class="media align-items-center">
								<span class="avatar avatar-sm rounded-circle"> <img
									alt="Image placeholder" src="src/images/<%=u.getImage_name()%>">
								</span>
								<div class="media-body ml-2 d-none d-lg-block">
									<span class="mb-0 text-sm  font-weight-bold"><%=u.getName()%>
									</span>
								</div>
							</div>
					</a>
		...
		<div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center"
			style="min-height: 600px; background-image:src/images/<%=u.getImage_name()%>; background-size: cover; background-position: center top;">
			<!-- Mask -->
					...
					<div class="card card-profile shadow">
						<div class="row justify-content-center">
							<div class="col-lg-3 order-lg-2">
								<div class="card-profile-image">
									<a href="#"> <img src="src/images/<%=u.getImage_name()%>"
						...
						<div class="card-body pt-0 pt-md-4">
							...
							<div class="text-center">
								<h3>
									<%=u.getName()  %><span class="font-weight-light">
										<!-- age aayega-->
									</span>
								</h3>
								<div class="h5 font-weight-300">
									<i class="ni location_pin mr-2"></i><%=u.getProfiletype()%>
								</div>
								<div class="h5 mt-4">
									<i class="ni business_briefcase-24 mr-2"></i>Eduction - MBBS
								</div>
								<div>
									<i class="ni education_hat mr-2"></i>University of Maharastra
								</div>
								<hr class="my-4">
								<p>We feel very privileged when we encounter the happy
									faces, which are the result of our hard work.</p>
								<a href="#">Show more</a>
							</div>
						</div>
					</div>
										...
										<div class="col-lg-6">
											<div class="form-group focused">
												...
												<input type="text" id="input-username"
													...
													placeholder="Username" value="<%=u.getName()%>">
											</div>
										</div>
										<div class="col-lg-6">
										...
										<div class="col-lg-6">
											<div class="form-group focused">
												<label class="form-control-label" for="input-first-name">First
													...
													class="form-control form-control-alternative"
													placeholder="First name" value="<%=u.getName()  %>">
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group focused">
												<label class="form-control-label" for="input-last-name">Mobile
													number</label> <input type="text" id="input-last-name"
													class="form-control form-control-alternative"
													placeholder="Last name" value="<%=u.getPhone() %>">
											</div>
										</div>
									</div>
								</div>
